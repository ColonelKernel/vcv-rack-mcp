...
Scanned across 12 source roots and 150 files,
...
| `undoable` | `json_true()` | `plugins/RackMCP/src/rackside/Transaction.cpp:374` |
| `undoEligible` | `json_true()` | `plugins/RackMCP/src/rackside/Transaction.cpp:1067` |
| `undone` | `json_true()` | `plugins/RackMCP/src/rackside/Transaction.cpp:1122` |
